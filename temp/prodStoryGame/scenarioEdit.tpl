...
１．アプリをダウンロードします<br />
<a href="{$resources}/story_game.zip" title="Windows用テスト用の実行ファイル">
テスト用実行ファイルfor Win</a><br />
<a href="{$resources}/story_game.app.zip" title="Mac用テスト用の実行ファイル">
テスト用実行ファイルfor Mac</a><br />
<br />

２．アプリが実行可能か確認する<br />
圧縮ファイルを解凍するとexeファイルがあるのでそれを実行してください。<br />
<img src="{$resources}/website/editScenario/001.jpg"><br />
<br /><br />
...
<img src="{$resources}/website/editScenario/003.jpg"><br />
<br /><br />
...
<br />
<img src="{$resources}/website/editScenario/004.jpg"><br />
<br />
