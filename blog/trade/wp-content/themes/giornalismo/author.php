	...
	<?php while (have_posts()) : the_post(); ?>
		<article id="<?php the_ID(); ?>" <?php post_class('story'); ?>>
			...
			<header class="index-header">
				...
				<h5 class="byline"><?php echo giornalismo_author_byline(); ?><?php the_time('M j, Y');?>, <?php comments_popup_link(__('0 Comments', 'giornalismo'), __('1 Comment', 'giornalismo'), __('% Comments', 'giornalismo'),'', __('Comments Off', 'giornalismo')); ?></h5>
